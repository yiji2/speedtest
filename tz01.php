...
#page {max-width: 1080px; padding: 0 auto; margin: 0 auto; text-align: left;}
...
<script language="JavaScript" type="text/javascript" src="//cdn.bootcss.com/jquery/3.2.1/jquery.min.js"></script>
...
<div id="footer">
&copy; <?php echo date("Y",time());?> <A HREF="http://www.Yahei.Net" target="_blank"><?php echo $title.$version;?></A> <a href="mailto:chdoqsuca@mozmail.com?subject=Dedipath Prober Feedback">- Feedback? -</a> All Rights Reserved.<br />
