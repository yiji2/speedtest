...
<div id="footer">
&copy; <?php echo date("Y",time());?> <A HREF="http://www.Yahei.Net" target="_blank"><?php echo $title.$version;?></A> <a href="mailto:gsaapvdq@duck.com?subject=Dedipath Prober Feedback">- Feedback? -</a> All Rights Reserved.<br />
